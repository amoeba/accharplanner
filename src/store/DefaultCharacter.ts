...
export default function (): Character {
  return {
    ...
    items: {
      ...
      trinket_augmented_damage_i: false,
      trinket_augmented_damage_ii: false,
      trinket_augmented_damage_iii: false,
      trinket_augmented_damage_reduction_i: false,
      trinket_augmented_damage_reduction_ii: false,
      trinket_augmented_damage_reduction_iii: false,
      trinket_augmented_understanding_i: false,
      trinket_augmented_understanding_ii: false,
      trinket_augmented_understanding_iii: false,
      trinket_augmented_health_i: false,
      trinket_augmented_health_ii: false,
      trinket_augmented_health_iii: false,
      trinket_augmented_mana_i: false,
      trinket_augmented_mana_ii: false,
      trinket_augmented_mana_iii: false,
    },
    armor_sets: {
      adepts: {
        equipped: 0,
