...
export default new Vuex.Store({
  ...
  getters: {
    ...
    armor_tinkeringBase: (state, getters) => {
      return Math.round((getters.enduranceBase + getters.focusBase) / 2) +
    ...
    armor_tinkeringBuffed: (state, getters) => {
      return getters.armor_tinkeringBase +
    ...
    assess_creatureBase: (state, getters) => {
      return Helpers.trainingBonus(state.character.skills.assess_creature.training) +
        state.character.timesEnlightened +
        state.character.skills.assess_creature.invested;
    },
    assess_creatureBuffed: (state, getters) => {
      return getters.assess_creatureBase +
    ...
    assess_personBase: (state, getters) => {
      return Helpers.trainingBonus(state.character.skills.assess_person.training) +
        state.character.timesEnlightened +
        state.character.skills.assess_person.invested;
    },
    assess_personBuffed: (state, getters) => {
      return getters.assess_personBase +
    ...
    creature_enchantmentBase: (state, getters) => {
      return Math.round((getters.focusBase + getters.selfBase) / 4) +
        Helpers.trainingBonus(state.character.skills.creature_enchantment.training) +
        state.character.timesEnlightened +
        state.character.skills.creature_enchantment.invested;
    },
    creature_enchantmentBuffed: (state, getters) => {
      return getters.creature_enchantmentBase +
        Helpers.buffBonus(state.character.skills.creature_enchantment.buff) +
        Helpers.cantripBonus(state.character.skills.creature_enchantment.cantrip) +
        Math.round((
          Helpers.buffBonus(state.character.attributes.focus.buff) + 
    ...
    deceptionBase: (state, getters) => {
      return Helpers.trainingBonus(state.character.skills.deception.training) +
        state.character.timesEnlightened +
        state.character.skills.deception.invested;
    },
    deceptionBuffed: (state, getters) => {
      return getters.deceptionBase +
    ...
    dirty_fightingBase: (state, getters) => {
      return Math.round((getters.strengthBase + getters.coordinationBase) / 3) +
    ...
    dirty_fightingBuffed: (state, getters) => {
      return getters.dirty_fightingBase +
    ...
    dual_wieldBase: (state, getters) => {
      return Math.round((getters.coordinationBase + getters.coordinationBase) / 3) +
    ...
    finesse_weaponsBuffed: (state, getters) => {
      return getters.finesse_weaponsBase +
    ...
    heavy_weaponsBuffed: (state, getters) => {
      return getters.heavy_weaponsBase +
    ...
    item_enchantmentBuffed: (state, getters) => {
      return getters.item_enchantmentBase +
    ...
    item_tinkeringBase: (state, getters) => {
      return Math.round((getters.coordinationBase + getters.focusBase) / 2) +
    ...
    item_tinkeringBuffed: (state, getters) => {
      return getters.item_tinkeringBase +
    ...
    leadershipBase: (state, getters) => {
      return Helpers.trainingBonus(state.character.skills.leadership.training) +
        state.character.timesEnlightened +
        state.character.skills.leadership.invested;
    },
    leadershipBuffed: (state, getters) => {
      return getters.leadershipBase +
    ...
    light_weaponsBuffed: (state, getters) => {
      return getters.light_weaponsBase +
    ...
    loyaltyBase: (state, getters) => {
      return Helpers.trainingBonus(state.character.skills.loyalty.training) +
        state.character.timesEnlightened +
        state.character.skills.loyalty.invested;
    },
    loyaltyBuffed: (state, getters) => {
      return getters.loyaltyBase +
    ...
    magic_defenseBase: (state, getters) => {
      return Math.round((getters.focusBase + getters.selfBase) / 7) +
    ...
    magic_defenseBuffed: (state, getters) => {
      return getters.magic_defenseBase +
    ...
    magic_item_tinkeringBase: (state, getters) => {
      return getters.focusBase +
        Helpers.trainingBonus(state.character.skills.magic_item_tinkering.training) +
        state.character.timesEnlightened +
        state.character.skills.magic_item_tinkering.invested;
    },
    magic_item_tinkeringBuffed: (state, getters) => {
      return getters.magic_item_tinkeringBase +
        Helpers.buffBonus(state.character.skills.magic_item_tinkering.buff) +
        Helpers.cantripBonus(state.character.skills.magic_item_tinkering.cantrip) +
        Helpers.buffBonus(state.character.attributes.focus.buff);
    },
    mana_conversionBase: (state, getters) => {
      return Math.round((getters.focusBase + getters.selfBase) / 6) +
    ...
    mana_conversionBuffed: (state, getters) => {
      return getters.mana_conversionBase +
    ...
    missile_defenseBase: (state, getters) => {
      return Math.round((getters.coordinationBase + getters.quicknessBase) / 5) +
    ...
    missile_defenseBuffed: (state, getters) => {
      return getters.missile_defenseBase +
    ...
    missile_weaponsBase: (state, getters) => {
      return Math.round(getters.coordinationBase / 2) +
    ...
    missile_weaponsBuffed: (state, getters) => {
      return getters.missile_weaponsBase +
        ...
        Math.round(Helpers.buffBonus(state.character.attributes.coordination.buff) / 2);
    },
    recklessnessBase: (state, getters) => {
      return Math.round((getters.strengthBase + getters.quicknessBase) / 3) +
    ...
    recklessnessBuffed: (state, getters) => {
      return getters.recklessnessBase +
    ...
    sneak_attackBuffed: (state, getters) => {
      return getters.sneak_attackBase +
    ...
    summoningBase: (state, getters) => {
      return Math.round((getters.enduranceBase + getters.selfBase) / 3) +
    ...
    two_handed_combatBuffed: (state, getters) => {
      return getters.two_handed_combatBase +
    ...
    weapon_tinkeringBase: (state, getters) => {
      return Math.round((getters.focusBase + getters.selfBase) / 2) +
    ...
    weapon_tinkeringBuffed: (state, getters) => {
      return getters.weapon_tinkeringBase +
