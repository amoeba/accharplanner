...
const AUGMENTATION_COST = {
  might_of_the_seventh_mule: [0, 1e9, 2e9, 3e9, 4e9, 5e9],
  ...
  clutch_of_the_miser: [0, 2e9, 4e9, 6e9],
  ...
  reinforcement_of_the_lugians: [0, 5e8, 10e8, 15e8, 20e8, 25e8, 30e8, 35e8, 40e8, 45e8, 50e8],
  bleearghs_fortitude: [0, 5e8, 10e8, 15e8, 20e8, 25e8, 30e8, 35e8, 40e8, 45e8, 50e8],
  oswalds_enhancement: [0, 5e8, 10e8, 15e8, 20e8, 25e8, 30e8, 35e8, 40e8, 45e8, 50e8],
  siraluuns_blessing: [0, 5e8, 10e8, 15e8, 20e8, 25e8, 30e8, 35e8, 40e8, 45e8, 50e8],
  enduring_calm: [0, 5e8, 10e8, 15e8, 20e8, 25e8, 30e8, 35e8, 40e8, 45e8, 50e8],
  steadfast_will: [0, 5e8, 10e8, 15e8, 20e8, 25e8, 30e8, 35e8, 40e8, 45e8, 50e8],
  enhancement_of_the_mace_turner: [0, 2e9, 4e9],
  enhancement_of_the_blade_turner: [0, 2e9, 4e9],
  enhancement_of_the_arrow_turner: [0, 2e9, 4e9],
  storms_enhancement: [0, 2e9, 4e9],
  fiery_enhancement: [0, 2e9, 4e9],
  icy_enhancement: [0, 2e9, 4e9],
  caustic_enhancement: [0, 2e9, 4e9],
  ...
  ciandras_fortune: [0, 1e9, 2e9, 3e9, 4e9],
  charmed_smith: [0, 2e9],
  ...
  archmages_endurance: [0, 1e9, 2e9, 3e9, 4e9, 5e9]
};
...
const LUMINANCE_AURA_NAME = {
  aetheric_vision: "Aetheric Vision",
  craftsman: "Craftsman",
  glory: "Glory",
  mana_flow: "Mana Flow",
  manu_infusion: "Mana Fusion",
...
const LUMINANCE_AURA_COST = {
  aetheric_vision: [0, 100000, 250000, 450000, 600000, 900000],
  craftsman: [0, 100000, 250000, 450000, 600000, 900000],
  glory: [0, 100000, 250000, 450000, 600000, 900000],
  mana_flow: [0, 100000, 250000, 450000, 600000, 900000],
  manu_infusion: [0, 100000, 250000, 450000, 600000, 900000],
  protection: [0, 100000, 250000, 450000, 600000, 900000],
  purity: [0, 100000, 250000, 450000, 600000, 900000],
  skill: [0, 1e6, 2e6],
  temperance: [0, 100000, 250000, 450000, 600000, 900000],
  valor: [0, 100000, 250000, 450000, 600000, 900000],
  world: [0, 100000, 300000, 600000, 1000000, 1500000, 2100000, 2800000, 3600000, 4500000, 5500000],
  specialization: [0, 350000, 750000, 1200000, 1700000, 2250000],
  invulnerability: [0, 350000, 750000, 1200000, 1700000, 2250000],
  destruction: [0, 350000, 750000, 1200000, 1700000, 2250000],
  retribution: [0, 350000, 750000, 1200000, 1700000, 2250000],
  hardening: [0, 350000, 750000, 1200000, 1700000, 2250000],
};
