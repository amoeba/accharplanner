...
const SKILLS = [
  ...
  [Skill["Assess Creature"]],
  [Skill["Assess Person"]],
  [Skill.Cooking],
  [Skill["Creature Enchantment"]],
  [Skill.Deception],
  [Skill["Dual Wield"]],
...
const SKILL_DEPENDS_ON_ATTRIBUTES = {
  ...
  [Skill["Arcane Lore"]]: [Attribute.Focus],
  [Skill["Armor Tinkering"]]: [Attribute.Endurance, Attribute.Focus],
  [Skill["Assess Creature"]]: [],
  [Skill["Assess Person"]]: [],
  [Skill.Cooking]: [Attribute.Coordination, Attribute.Focus],
  [Skill["Creature Enchantment"]]: [Attribute.Focus, Attribute.Self],
  [Skill.Deception]: [],
  [Skill["Dual Wield"]]: [Attribute.Coordination],
  [Skill["Dirty Fighting"]]: [Attribute.Strength, Attribute.Coordination],
  [Skill["Finesse Weapons"]]: [Attribute.Coordination, Attribute.Quickness],
  [Skill.Fletching]: [Attribute.Coordination, Attribute.Focus],
  [Skill.Healing]: [Attribute.Coordination, Attribute.Focus],
  [Skill["Heavy Weapons"]]: [Attribute.Strength, Attribute.Coordination],
  [Skill["Item Enchantment"]]: [Attribute.Focus, Attribute.Self],
  [Skill["Item Tinkering"]]: [Attribute.Coordination, Attribute.Focus],
  [Skill.Jump]: [Attribute.Strength, Attribute.Coordination],
  [Skill.Leadership]: [],
  [Skill["Life Magic"]]: [Attribute.Focus, Attribute.Self],
  [Skill["Light Weapons"]]: [Attribute.Strength, Attribute.Coordination],
  [Skill.Lockpick]: [Attribute.Coordination, Attribute.Focus],
  [Skill.Loyalty]: [],
  [Skill["Magic Defense"]]: [Attribute.Focus, Attribute.Self],
  [Skill["Magic Item Tinkering"]]: [Attribute.Focus],
  [Skill["Mana Conversion"]]: [Attribute.Focus, Attribute.Self],
  [Skill["Melee Defense"]]: [Attribute.Coordination, Attribute.Quickness],
  [Skill["Missile Defense"]]: [Attribute.Coordination, Attribute.Quickness],
  [Skill["Missile Weapons"]]: [Attribute.Coordination],
  ...
  [Skill["Sneak Attack"]]: [Attribute.Coordination, Attribute.Quickness],
  [Skill.Summoning]: [Attribute.Endurance, Attribute.Self],
  [Skill["Two Handed Combat"]]: [Attribute.Strength, Attribute.Coordination],
  [Skill["Void Magic"]]: [Attribute.Focus, Attribute.Self],
  [Skill["Void Magic"]]: [Attribute.Focus, Attribute.Self],
  [Skill["Weapon Tinkering"]]: [Attribute.Focus, Attribute.Self]
};
...
const UNTRAINABLE = {
  ...
  [Skill["Assess Creature"]]: true,
  [Skill["Assess Person"]]: true,
  [Skill.Cooking]: true,
  [Skill["Creature Enchantment"]]: true,
  [Skill.Deception]: true,
  [Skill["Dual Wield"]]: true,
  [Skill["Dirty Fighting"]]: true,
  [Skill["Finesse Weapons"]]: true,
  [Skill.Fletching]: true,
  [Skill.Healing]: true,
  [Skill["Heavy Weapons"]]: true,
  [Skill["Item Enchantment"]]: true,
  [Skill["Item Tinkering"]]: true,
  [Skill.Jump]: false,
  [Skill.Leadership]: true,
  [Skill["Life Magic"]]: true,
  [Skill["Light Weapons"]]: true,
  [Skill.Lockpick]: true,
  [Skill.Loyalty]: false,
  [Skill["Magic Defense"]]: false,
  [Skill["Magic Item Tinkering"]]: true,
  [Skill["Mana Conversion"]]: true,
  [Skill["Melee Defense"]]: true,
  [Skill["Missile Defense"]]: true,
  [Skill["Missile Weapons"]]: true,
  [Skill.Recklessness]: true,
  [Skill.Run]: false,
  [Skill.Salvaging]: false,
  [Skill.Shield]: true,
  [Skill["Sneak Attack"]]: true,
  [Skill.Summoning]: true,
  [Skill["Two Handed Combat"]]: true,
  [Skill["Void Magic"]]: true,
  [Skill["Void Magic"]]: true,
...
const UNTRAINED_STATE = {
  ...
  [Skill["Arcane Lore"]]: Training.TRAINED,
  [Skill["Armor Tinkering"]]: Training.UNTRAINED,
  [Skill["Assess Creature"]]: Training.UNUSABLE,
  [Skill["Assess Person"]]: Training.UNUSABLE,
  [Skill.Cooking]: Training.UNUSABLE,
  [Skill["Creature Enchantment"]]: Training.UNUSABLE,
  [Skill.Deception]: Training.UNUSABLE,
  [Skill["Dual Wield"]]: Training.UNUSABLE,
  [Skill["Dirty Fighting"]]: Training.UNUSABLE,
  [Skill["Finesse Weapons"]]: Training.UNTRAINED,
  [Skill.Fletching]: Training.UNUSABLE,
  [Skill.Healing]: Training.UNUSABLE,
  [Skill["Heavy Weapons"]]: Training.UNTRAINED,
  [Skill["Item Enchantment"]]: Training.UNUSABLE,
  [Skill["Item Tinkering"]]: Training.UNTRAINED,
  [Skill.Jump]: Training.TRAINED,
  [Skill.Leadership]: Training.UNTRAINED,
  [Skill["Life Magic"]]: Training.UNUSABLE,
  [Skill["Light Weapons"]]: Training.UNTRAINED,
  [Skill.Lockpick]: Training.UNUSABLE,
  [Skill.Loyalty]: Training.TRAINED,
  [Skill["Magic Defense"]]: Training.TRAINED,
  [Skill["Magic Item Tinkering"]]: Training.UNTRAINED,
  [Skill["Mana Conversion"]]: Training.UNUSABLE,
  [Skill["Melee Defense"]]: Training.UNTRAINED,
  [Skill["Missile Defense"]]: Training.UNTRAINED,
  [Skill["Missile Weapons"]]: Training.UNTRAINED,
  ...
  [Skill["Sneak Attack"]]: Training.UNUSABLE,
  [Skill.Summoning]: Training.UNTRAINED,
  [Skill["Two Handed Combat"]]: Training.UNTRAINED,
  [Skill["Void Magic"]]: Training.UNUSABLE,
  [Skill["War Magic"]]: Training.UNUSABLE,
...
const COST_SKILL_POINTS = {
  ...
  [Skill["Assess Creature"]]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 6 },
  [Skill["Assess Person"]]: { [Training.TRAINED]: 2, [Training.SPECIALIZED]: 4 },
  [Skill.Cooking]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 8 },
  [Skill["Creature Enchantment"]]: { [Training.TRAINED]: 8, [Training.SPECIALIZED]: 16 },
  [Skill.Deception]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 6 },
  [Skill["Dirty Fighting"]]: { [Training.TRAINED]: 2, [Training.SPECIALIZED]: 4 },
  [Skill["Dual Wield"]]: { [Training.TRAINED]: 2, [Training.SPECIALIZED]: 4 },
  [Skill["Finesse Weapons"]]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 8 },
  [Skill.Fletching]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 8 },
  [Skill.Healing]: { [Training.TRAINED]: 6, [Training.SPECIALIZED]: 10 },
  [Skill["Heavy Weapons"]]: { [Training.TRAINED]: 6, [Training.SPECIALIZED]: 12 },
  [Skill["Item Enchantment"]]: { [Training.TRAINED]: 8, [Training.SPECIALIZED]: 16 },
  [Skill["Item Tinkering"]]: { [Training.TRAINED]: 2, [Training.SPECIALIZED]: 0 },
  [Skill.Jump]: { [Training.TRAINED]: 0, [Training.SPECIALIZED]: 4 },
  [Skill.Leadership]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 6 },
  [Skill["Life Magic"]]: { [Training.TRAINED]: 12, [Training.SPECIALIZED]: 20 },
  [Skill["Light Weapons"]]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 8 },
  [Skill.Lockpick]: { [Training.TRAINED]: 6, [Training.SPECIALIZED]: 10 },
  [Skill.Loyalty]: { [Training.TRAINED]: 0, [Training.SPECIALIZED]: 2 },
  [Skill["Magic Defense"]]: { [Training.TRAINED]: 0, [Training.SPECIALIZED]: 12 },
  [Skill["Magic Item Tinkering"]]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 0 },
  [Skill["Mana Conversion"]]: { [Training.TRAINED]: 6, [Training.SPECIALIZED]: 12 },
  [Skill["Melee Defense"]]: { [Training.TRAINED]: 10, [Training.SPECIALIZED]: 20 },
  [Skill["Missile Defense"]]: { [Training.TRAINED]: 6, [Training.SPECIALIZED]: 10 },
  [Skill["Missile Weapons"]]: { [Training.TRAINED]: 6, [Training.SPECIALIZED]: 12 },
  ...
  [Skill["Sneak Attack"]]: { [Training.TRAINED]: 4, [Training.SPECIALIZED]: 6 },
  [Skill.Summoning]: { [Training.TRAINED]: 8, [Training.SPECIALIZED]: 12 },
  [Skill["Two Handed Combat"]]: { [Training.TRAINED]: 8, [Training.SPECIALIZED]: 16 },
  [Skill["Void Magic"]]: { [Training.TRAINED]: 16, [Training.SPECIALIZED]: 28 },
  [Skill["Void Magic"]]: { [Training.TRAINED]: 16, [Training.SPECIALIZED]: 28 },
...
const SPEC_COSTS_AUG = {
  ...
  [Skill["Arcane Lore"]]: false,
  [Skill["Armor Tinkering"]]: true,
  [Skill["Assess Creature"]]: false,
  [Skill["Assess Person"]]: false,
  [Skill.Cooking]: false,
  [Skill["Creature Enchantment"]]: false,
  [Skill.Deception]: false,
  [Skill["Dual Wield"]]: false,
  [Skill["Dirty Fighting"]]: false,
  [Skill["Finesse Weapons"]]: false,
  [Skill.Fletching]: false,
  [Skill.Healing]: false,
  [Skill["Heavy Weapons"]]: false,
  [Skill["Item Enchantment"]]: false,
  [Skill["Item Tinkering"]]: true,
  [Skill.Jump]: false,
  [Skill.Leadership]: false,
  [Skill["Life Magic"]]: false,
  [Skill["Light Weapons"]]: false,
  [Skill.Lockpick]: false,
  [Skill.Loyalty]: false,
  [Skill["Magic Defense"]]: false,
  [Skill["Magic Item Tinkering"]]: true,
  [Skill["Mana Conversion"]]: false,
  [Skill["Melee Defense"]]: false,
  [Skill["Missile Defense"]]: false,
  [Skill["Missile Weapons"]]: false,
  [Skill.Recklessness]: false,
  [Skill.Run]: false,
  [Skill.Salvaging]: true,
  [Skill.Shield]: false,
  [Skill["Sneak Attack"]]: false,
  [Skill.Summoning]: false,
  [Skill["Two Handed Combat"]]: false,
  [Skill["Void Magic"]]: false,
  [Skill["Void Magic"]]: false,
  [Skill["Weapon Tinkering"]]: true
};
