  ...
  <header class="grid grid-cols-[auto_auto] items-center px-2 py-1">
    <div class="flex gap-4 items-baseline">
      <div class="flex items-baseline gap-1">
        ...
        <span
          class="z-10 my-subtitle absolute top-8 left-10 opacity-0 transition-all duration-300 text-black text-xs dark:bg-inherit"
        >The
          Overly-Detailed
          Asheron's
          Call Character
      ...
      <NuxtLink to="/builds" class="hover:underline">
        Builds
      </NuxtLink>
      <NuxtLink to="/guides" class="hover:underline">
        Guides
      </NuxtLink>
    </div>
    <div class="flex gap-2 justify-self-end items-center px-2 py-1">
      <button @click="doToggleDarkMode">
        <svg
          v-if="store.darkMode" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
      ...
      <NuxtLink to="https://discord.gg/r3jt93vYEb">
        <svg
          width="24" height="24" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg"
