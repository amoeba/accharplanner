...
<template>
  <header class="grid grid-cols-[auto_auto] items-center p-2">
    <div class="flex items-center gap-4">
      <div class="flex gap-1">
        ...
        <span
          class="my-subtitle absolute left-10 top-8 z-10 text-xs text-black opacity-0 transition-all duration-300 dark:bg-inherit"
        >The
          Overly-Detailed
          Asheron's
          Call Character
    ...
    <div class="flex items-center gap-2 justify-self-end">
      ...
      <BurgerMenu class="block sm:hidden" />
    </div>
  </header>
</template>
