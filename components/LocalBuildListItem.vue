...
<template>
  <div class="flex gap-2 items-center">
    <span class="font-bold">{{ build.character.name }}</span> <span class="text-zinc-500">Saved {{ saved }}</span>
    <ButtonView @click="loadBuild" class="inline-flex">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-up-from-line">
