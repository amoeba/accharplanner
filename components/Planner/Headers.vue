<template>
  <div class="headers">
    ...
    <Pane>
      ...
      <template #right> <span class="tip" v-tooltip="'These numbers are a bit of a work in progress. Total and Required Level tend to match pretty well but Unassigned and Spent seem to get way off sometimes.'
        ">!</span></template>
      <template #content>
        <div>Unassigned</div>
        <div class="right">
